...
func ListProductIndex2(products []controllers.ProcessedProduct, fieldNames []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, field := range fieldNames {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/product_views/product_list.templ`, Line: 15, Col: 35}
			}
		...
		for _, product := range products {
			...
			for index, value := range product.Values {
				...
				if fieldNames[index] == "SKU" {
					...
					var templ_7745c5c3_Var3 templ.SafeURL = templ.SafeURL("/products/" + value)
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/product_views/product_list.templ`, Line: 30, Col: 47}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/product_views/product_list.templ`, Line: 33, Col: 43}
					}
